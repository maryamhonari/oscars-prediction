...
\end{enumerate}
	...
	The Academy Awards, or "Oscars", is an annual American awards ceremony to recognize excellence in cinematic achievements of previous year's movies. These awards are presented from 1929 and known as a mark of distinguished performance in different categories which can bring fanfare.   
	
	One of the most controversial Oscar awards is Best picture.
	...
	This project attempts to predict which movie is most likely to nominate for or win an award.  So far we have implemented a number of classifiers to predict whether a movie will be nominated or win an award. The important questions that we intend to answer in this project are:
	...
	In this project we want to investigate how popularity and social media attentions affects Oscare's results.
